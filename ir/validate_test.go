...
func TestValidate_OpenClawExamples(t *testing.T) {
	// Test that our example JSON files pass validation
	examples := []string{
		"../examples/openclaw/dfd.json",
		"../examples/openclaw/attack_chain.json",
		"../examples/openclaw/attack_sequence.json",
	}
